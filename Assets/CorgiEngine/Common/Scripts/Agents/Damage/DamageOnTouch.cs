...
{	
	/// <summary>
	/// Add this component to an object and it will cause damage to objects that collide with it if it is in a sliding state. 
	/// </summary>
	...
	public class DamageOnTouch : MonoBehaviour 
	{
		...
		/// If true, this will stun the character on contact
		[Tooltip("If true, this will stun the character on contact")]
		public bool Stun = false;
		/// Length of the stun
		[Tooltip("Length of the stun")]
	    ...
	    protected virtual void OnCollideWithDamageable(Health health)
	    {
			...
			if (Stun)
            {
				ElectrocuteEvent.Trigger(StunLength);
            }
			...
			CharacterDash colliderDash = health.gameObject.MMGetComponentNoAlloc<CharacterDash>();
			if (colliderDash != null)
				colliderDash.StopDash();
