...
namespace MoreMountains.CorgiEngine
{
    ...
    public class ProjectileWeapon : Weapon
    {
		...
		public virtual GameObject SpawnProjectile(Vector3 spawnPosition, int projectileIndex, int totalProjectiles, bool triggerObjectActivation = true)
		{
			...
			// mandatory checks
			if (nextGameObject==null)	{ Debug.Log("no next object");  return null; }
        ...
        {
            if (LManager.CheckPlayerProximity(this.transform.position) && ObjectPooler.GetPooledGameObject() != null)
            {
