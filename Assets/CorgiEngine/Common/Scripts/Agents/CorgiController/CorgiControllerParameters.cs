...
{	
	...
	public class CorgiControllerParameters 
	{
		...
		/// a speed modifier to apply when applying input in the opposite direction of movement when on the ground
		[Tooltip("a speed modifier to apply when applying input in the opposite direction of movement when on the ground")]
		public float SpeedReverseAccelerationOnGround = 2f;
		...
		/// a speed modifier to apply when applying input in the opposite direction of movement when in the air
		[Tooltip("a speed modifier to apply when applying input in the opposite direction of movement when in the air")]
		public float SpeedReverseAccelerationInAir = 1f;
