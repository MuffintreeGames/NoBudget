...
{	
	...
	public class CharacterHorizontalMovement : CharacterAbility 
	{
		...
		{	
			...
			} else if (_horizontalMovement * _horizontalMovementForce < 0 && groundAcceleration < _controller.Parameters.SpeedDecelerationOnGround) {
				groundAcceleration = _controller.Parameters.SpeedReverseAccelerationOnGround;
			}
