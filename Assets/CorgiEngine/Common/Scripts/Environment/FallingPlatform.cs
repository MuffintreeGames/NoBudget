...
{	
	...
	public class FallingPlatform : MonoBehaviour 
	{
		...
		/// if true, platform will fall even if the player steps off of it before the timer finishes
		[Tooltip("if true, platform will fall even if the player steps off of it before the timer finishes")]
