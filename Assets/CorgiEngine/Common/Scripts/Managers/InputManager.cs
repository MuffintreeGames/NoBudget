...
namespace MoreMountains.CorgiEngine
{
	...
	public class InputManager : MMSingleton<InputManager>
	{
		...
		/// the slide button
		 public MMInput.IMButton SlideButton { get; protected set; }
		/// the dash button
		...
		public MMInput.IMButton FeatureTestButton { get; protected set; }
		...
		protected virtual void InitializeButtons()
		{
			...
			ButtonList.Add(SlideButton = new MMInput.IMButton(PlayerID, "Slide", SlideButtonDown, SlideButtonPressed, SlideButtonUp));
			...
			ButtonList.Add(FeatureTestButton = new MMInput.IMButton(PlayerID, "FeatureTest", FeatureTestButtonDown, FeatureTestButtonPressed, FeatureTestButtonUp));
        }
		...
		public virtual void SlideButtonDown()				{ SlideButton.State.ChangeState(MMInput.ButtonStates.ButtonDown); }
		public virtual void SlideButtonPressed()			{ SlideButton.State.ChangeState(MMInput.ButtonStates.ButtonPressed); }
		public virtual void SlideButtonUp()					{ SlideButton.State.ChangeState(MMInput.ButtonStates.ButtonUp); }
		...
		public virtual void FeatureTestButtonDown() { FeatureTestButton.State.ChangeState(MMInput.ButtonStates.ButtonDown); }
		public virtual void FeatureTestButtonPressed() { FeatureTestButton.State.ChangeState(MMInput.ButtonStates.ButtonPressed); }
		public virtual void FeatureTestButtonUp() { FeatureTestButton.State.ChangeState(MMInput.ButtonStates.ButtonUp); }
