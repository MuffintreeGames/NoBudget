...
namespace MoreMountains.Tools
{
                                    ...
                                    MMEventListener<MMSoundManagerTrackFadeEvent>
    {
        ...
        public virtual void OnMMSfxEvent(AudioClip clipToPlay, AudioMixerGroup audioGroup = null, float volume = 1f, float pitch = 1f, bool persistent = false, bool music = false)
        {
            ...
            if (music)
            {
                options.MmSoundManagerTrack = MMSoundManagerTracks.Music;
            }
            else
            {
