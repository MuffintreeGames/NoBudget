...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMFeedbackSound : MMFeedback
    {
        ...
        /// if true, sound will continue between scenes
        [Tooltip("if true, sound will continue between scenes")]
        ...
        protected virtual void PlaySound(AudioClip sfx, Vector3 position, float intensity)
        {
            ...
            {
                MMSfxEvent.Trigger(sfx, SfxAudioMixerGroup, volume, pitch, Persistent, Music);
                return;
            }
